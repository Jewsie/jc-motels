    ...
    ['marathon_motel'] = {
        {
            ...
            multipleDoors = false, -- Set to true if it's either doubledoors or multiple doors!
            -- multipleDoor  = true example; These are not existing matching doorhashes!! They are mere examples!
            --[[
                doorCoords = {
                    {
                        coords = vector3(-1494.44, -668.33, 29.28),
                        doorHash = -2123441472,
                    },
                    {
                        coords = vector3(-1498.82, -664.72, 29.29),
                        doorHash = -3177181021,
                    },
                }
            ]]
            doorCoords = vector3(-1494.44, -668.33, 29.28), -- Where the door is placed! Only used when multipleDoors is set to false, otherwise use template for table above! ^^
            targetCoords = vector3(-1493.64, -668.22, 29.03), -- Where the target to lock and unlock the door is!
            doorHash = -2123441472, -- The hash of the door! Only used when multipleDoors is set to false
